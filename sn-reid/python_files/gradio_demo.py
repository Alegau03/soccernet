...
MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'final_models', 'OsNet.tar')
...
def extract_all_features():
    ...
    dataset = Soccernetv3(root=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'datasets'), soccernetv3_training_subset=1.0)
